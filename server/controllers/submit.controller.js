...
exports.submitTicket = async (title, type, urgency, description, name, email) => {
    ...
    // SQL INSERT Query
    await pool.query("INSERT INTO tickets(title, type, urgency, description, date_submitted, status, client_name, client_email) VALUES ($1, $2, $3, $4, $5, $6, $7, $8)", [title, type, urgency, description, date, "Backlog", name, email]);
}